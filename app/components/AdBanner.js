'use client'; // Mütləq əlavə edilməlidir, çünki localStorage istifadə edəcəyik
...
export default function AdBanner() {
  ...
  // Komponent brauzerdə ekrana gələn kimi yaddasda 'isPremium' bayrağını yoxlayırıq
  useEffect(() => {
  ...
  // Əgər istifadəçi premiumdursa, heç nə render etmirik (reklamlar tamamilə gizlənir)
  if (isPremium) {
    return null;
  }

  // İstifadəçi premium deyilsə, reklamlar görünməyə davam edir
  return (
    <>
      {/* 1) Top marquee strip */}
